...
h1.config(height=1,width=20,command=h1f)
h1.grid(row=7, column=0)
h2=tkinter.Button(text="Customer_email_Value_1:")
h2.config(height=1,width=20,command=h2f)
h2.grid(row=7, column=1)
h3=tkinter.Button(text="Attention_(Contact Name)_1:")
h3.config(height=1,width=20,command=h3f)
h3.grid(row=7, column=2)
h4=tkinter.Button(text="Attention_(Contact Name)_Value_1:")
h4.config(height=1,width=20,command=h4f)
